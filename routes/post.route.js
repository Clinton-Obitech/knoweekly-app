...
import { SendContactMessageController } from "../controllers/user/message/controller.js";
...
router.post("/post/blog", upload.single("image"), verifyAdminToken, postBlogController);
router.post("/manage/query", verifyAdminToken, manageByQueryController);
router.post("/update/:id/blog/", upload.single("image"), verifyAdminToken, updateBlogController);
router.post("/delete/blog/:id/:country/:category/:date", verifyAdminToken, deleteBlogController);

router.post("/create/site/info", verifyAdminToken, createInfoController);
router.post("/update/site/info/:id", verifyAdminToken, updateInfoController);
router.post("/delete/site/info/:id/:category", verifyAdminToken, deleteInfoController);
